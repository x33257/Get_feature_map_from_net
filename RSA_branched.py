...
def get_RDM(num_layers, num_imgs, num_tasks, task_dat_name_list):
    """Get a ndarray of RDM of N tasks using given parameters.
    ...
    Returns:
        A ndarray of RDM of N tasks with dimensions (N, D, K, K).
    """
...
def get_affinity_tensor(task_dat_path_list):
    ...
    Returns:
        A ndarray of affinity tensor with dimensions (D, N, N).
    """
